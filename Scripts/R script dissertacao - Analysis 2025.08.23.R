...
# oil producer is true for AK, CO, LA, ND, NM, OK, TX, WY
subset_analysis$oil_exporter <- ifelse(subset_analysis$state 
                                       %in% c("AK", "CO", "LA", "ND", "NM", "OK", "TX", "WY"), 1, 0)


#subset for only states that are oil_exporter
subset_oilexpt <- subset(subset_analysis, oil_exporter == 1)

pdim(subset_oilexpt)

lm(Approval_Not_Smoothed ~ oil_shock_positive_l1 * factor(state), data = subset_oilexpt) %>% summary()
...
plot(subset_oilexpt$Approval_Not_Smoothed)
...
barplot(table(subset_oilexpt$BSF_deposit_5level),
        col=rainbow(5),
        legend.text=TRUE,
        args.legend=list(x="topright", cex=0.7, bty="n"),
        main="BSF Deposit Rules 5 levels")

barplot(table(subset_oilexpt$BSF_deposit_3level),
        col=rainbow(3),
        main="BSF Deposit Rules 3 levels")

barplot(table(subset_oilexpt$BSF_withdrawal_5level),
        col=rainbow(5),
        legend.text=TRUE,
        args.legend=list(x="topright", cex=0.7, bty="n"),
        main="BSF Withdrawal Rules 5 levels")

barplot(table(subset_oilexpt$BSF_withdrawal_3level),
        col=rainbow(3),
...
barplot(table(subset_oilexpt$BSF_deposit_3level,subset_oilexpt$year),
        main="BSF Deposit Rules by Quarter",
        beside=FALSE,col=rainbow(3), legend.text=TRUE,
        args.legend=list(x="topleft", cex=0.7, bty="n"))

barplot(table(subset_oilexpt$BSF_deposit_5level,subset_oilexpt$year),
        main="BSF Deposit Rules by Quarter",
        beside=FALSE,col=rainbow(5), legend.text=TRUE,
        args.legend=list(x="topleft", cex=0.7, bty="n"))

barplot(table(subset_oilexpt$BSF_withdrawal_3level,subset_oilexpt$year),
        main="BSF Withdrawal Rules by Quarter",
        beside=FALSE,col=rainbow(3), legend.text=TRUE,
        args.legend=list(x="topleft", cex=0.7, bty="n"))

barplot(table(subset_oilexpt$BSF_withdrawal_5level,subset_oilexpt$year),
        main="BSF Withdrawal Rules by Quarter",
        beside=FALSE,col=rainbow(5), legend.text=TRUE,
        args.legend=list(x="topleft", cex=0.7, bty="n"))

table(subset_oilexpt$BSF_deposit_3level)
table(subset_oilexpt$BSF_deposit_5level)
table(subset_oilexpt$BSF_withdrawal_3level)
table(subset_oilexpt$BSF_withdrawal_5level)
...
oil_exporter <- c(
  "oil_exporter"
  ,"oil_exporter:oil_shock_positive_l1"
  ,"oil_exporter:oil_shock_positive_l2"
  ,"oil_exporter:oil_shock_positive_l3"
  ,"oil_exporter:oil_shock_positive_l4"
  #,"oil_exporter:oil_shock_positive_l5"
  ,"oil_exporter:oil_shock_negative_l1"
  ,"oil_exporter:oil_shock_negative_l2"
  ,"oil_exporter:oil_shock_negative_l3"
  ,"oil_exporter:oil_shock_negative_l4"
  #,"oil_exporter:oil_shock_negative_l5"
)
...
for (model in model_lists){
  ...
  print(summary(model$Disapproval_Not_Smoothed))
}
